...
llm = LLM(
    model="gemini/gemini-2.5-flash",   # model name in LiteLLM format
    api_key=os.getenv("LITELLM_API_KEY")  
)

# Instantiate the financial document tool
...
financial_analyst = Agent(
    ...
    tools=[financial_doc_tool],   # ✅ FIXED: use the instantiated tool
    llm=llm,
    max_iter=1,
    max_rpm=1,
